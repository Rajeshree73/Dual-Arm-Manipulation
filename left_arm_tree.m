...
f(6).l_hand = 0;
f(7).l_palm = 0;
f(8).l_finger_1_link_0 = 0;
f(9).l_finger_1_link_1 = 0;
f(10).l_finger_1_link_2 = 0;
f(11).l_finger_1_link_3 = 0;
f(12).l_finger_1_link_paradistal_hinge = 0;
f(13).l_finger_1_link_median_actuating_hinge = 0;
f(14).l_finger_1_link_median_bar = 0;
f(15).l_finger_1_link_paramedian_hinge = 0;
f(16).l_finger_1_link_median_bar_underactuated = 0;
f(17).l_finger_1_link_paraproximal_actuating_hinge = 0;
f(18).l_finger_1_link_paraproximal_bar = 0;
f(19).l_finger_1_link_proximal_actuating_hinge = 0;
f(20).l_finger_1_link_proximal_actuating_bar = 0;
f(21).l_finger_2_link_0 = 0;
f(22).l_finger_2_link_1 = 0;
f(23).l_finger_2_link_2 = 0;
f(24).l_finger_2_link_3 = 0;
f(25).l_finger_2_link_paradistal_hinge = 0;
f(26).l_finger_2_link_median_actuating_hinge = 0;
f(27).l_finger_2_link_median_bar = 0;
f(28).l_finger_2_link_paramedian_hinge = 0;
f(29).l_finger_2_link_median_bar_underactuated = 0;
f(30).l_finger_2_link_paraproximal_actuating_hinge = 0;
f(31).l_finger_2_link_paraproximal_bar = 0;
f(32).l_finger_2_link_proximal_actuating_hinge = 0;
f(33).l_finger_2_link_proximal_actuating_bar = 0;
f(34).l_finger_middle_link_0  = 0;
f(35).l_finger_middle_link_1 = 0;
f(36).l_finger_middle_link_2 = 0;
f(37).l_finger_middle_link_3 = 0;
f(38).l_finger_middle_link_paradistal_hinge = 0;
f(39).l_finger_middle_link_median_actuating_hinge = 0;
f(40).l_finger_middle_link_median_bar = 0;
f(41).l_finger_middle_link_paramedian_hinge = 0;
f(42).l_finger_middle_link_median_bar_underactuated = 0;
f(43).l_finger_middle_link_paraproximal_actuating_hinge = 0;
f(44).l_finger_middle_link_paraproximal_bar = 0;
f(45).l_finger_middle_link_proximal_actuating_hinge = 0;
% f(46).l_finger_middle_link_proximal_actuating_bar = 0;
% f(47).l_end_eff = 0; 
